...
parameters are  `r round(alasso.fitMG@Penalize@tuning$shrink, 3)` for Penalty 1, 
`r round(alasso.fitMG@Penalize@tuning$diff[1], 3)` for Penalty 2, and 
`r round(alasso.fitMG@Penalize@tuning$diff[2], 3)` for Penalty 3.
...
See ["plotting-penalty-matrix"](https://egeminiani.github.io/penfa/articles/plotting-penalty-matrix.html) for details on how to produce interactive plots of the above penalty matrices.
